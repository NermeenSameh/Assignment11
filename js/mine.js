async function getWetherForecast(a) {
...
//     getWetherForecast(a.target.value)
// }

document.getElementById("findInput").addEventListener("click", a => {
    getWetherForecast(document.getElementById("searchInput").value)
}
);
